...
/** getCurrentUser GET /api/user/get/current */
export async function getCurrentUserUsingGet(options?: { [key: string]: any }) {
  return request<API.ResultLoginUserVO_>('/api/user/get/current', {
    method: 'GET',
    ...(options || {}),
  });
}
...
export async function userLoginUsingPost(
  ...
  return request<API.ResultHashMapStringObject_>('/api/user/login', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function updateMyUserUsingPost(
  ...
  return request<API.ResultBoolean_>('/api/user/update/my', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
